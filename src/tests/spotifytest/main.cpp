...
int main() {
    ...
    std::string captureDevice = "hw:3,0"; // Replace with the appropriate capture device file
    std::string playbackDevice = "hw:3,0"; // Replace with the appropriate playback device identifier
